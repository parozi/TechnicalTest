...
STATIC_URL = "/static/"
AUTH_USER_MODEL = "bonds.User"  # remove if migrationhistory is consistant
TIMEOUT = 300
TIMEOUT_TO_ACIVATE = 259200
DATE_INPUT_FORMATS = ["%Y-%m-%d"]
LEI_LOOKUP_URL = "https://leilookup.gleif.org/api/v2/leirecords?lei="
